...
op_t op_tab[] = {
    ...
    {"sub", 3, true, false, true,
    {T_REG, T_REG, T_REG}, 5, 10, "soustraction"},
    {"and", 3, true, false, true,
    {T_REG | T_DIR | T_IND, T_REG | T_IND | T_DIR,
    T_REG}, 6, 6, "et (and  r1, r2, r3   r1&r2 -> r3"},
    {"or", 3, true, false, true,
    {T_REG | T_IND | T_DIR, T_REG | T_IND | T_DIR,
    T_REG}, 7, 6, "ou  (or   r1, r2, r3   r1 | r2 -> r3"},
    {"xor", 3, true, false, true,
    {T_REG | T_IND | T_DIR, T_REG | T_IND | T_DIR,
    ...
    {"lld", 2, true, false, false,
    {T_DIR | T_IND, T_REG}, 13, 10, "long load"},
    {"lldi", 3, true, true, false,
